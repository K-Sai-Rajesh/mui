           ...
           <ListItem  sx={{ flexDirection:'column'}}>
              ...
              <Box sx={styles}>
                <Box sx={{display:'flex',flexDirection:'row',justifyContent:'center',alignItems:'center'}}>
                  <ListItemText>
                    <Typography variant='h6' sx={{fontSize:'15px',fontWeight:"bold",color:'orange'}}>Impact Score : 78</Typography>
                  </ListItemText>&ensp;
                  <ListItemIcon>
              ...
              <Box sx={{width:'100%'}}>
                ...
                <Paper sx={{p:2,backgroundColor:'#eceff1'}}>
                  <Typography sx={{fontSize:'12px', fontWeight:'bold'}} >Power Words from your content:</Typography>
